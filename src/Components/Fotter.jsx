        ...
        <div className="container mx-auto px-6 py-12">
          <div className="flex flex-wrap justify-between">
            <div className="w-full md:w-1/4 mb-6 md:mb-0">
              ...
              <p className="mt-2 text-gray-600 text-left">
                We offer trendy and stylish clothes that suit your personality
                and lifestyle. Find the perfect fit for any occasion.
              </p>
          ...
          <div className="flex flex-wrap justify-between items-center">
            <p className="text-gray-600 text-sm">
              Ecommerce © Made by <strong>Dev1</strong> and{" "}
              <strong>Dev2</strong>
            </p>
            <div className="flex space-x-2 mt-4">
              <img
                src="https://static-00.iconduck.com/assets.00/visa-icon-512x329-sscrc567.png"
                alt="Visa"
              ...
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF0s-Zy3zaDYeri6ZW8a5aPPekTUuuhyLOdQ&s"
                alt="Apple Pay"
                className="h-6 w-auto"
              />

              <img
                src="https://lh3.googleusercontent.com/KE8W2U_931n24DtWrvySEdKwnx6dLeaoaXBV6nXNHKbJd32mnIx-eaxXPdsRscJMT8vxyLy59XKVkr_UXlswXFJ2KjomzkqV-ud3=s0"
                alt="Google Pay"
                className="h-6 w-auto"
              />
            </div>
